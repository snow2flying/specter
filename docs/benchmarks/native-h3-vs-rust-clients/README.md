...
- `quiche_direct_rfc9220_tunnel` and `tokio_quiche_rfc9220_tunnel` are real measured low-level tunnel comparator rows at n=100 in `2026-05-24-rfc9220-n100.json`.
